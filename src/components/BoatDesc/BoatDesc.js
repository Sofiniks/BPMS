...
const BoatDesc = ({ item }) => {
    ...
    const additional = readyModelsState?.additional === 'almarcraft595' ? i18next.t('almarcraft595Add') :
        readyModelsState?.additional === 'almarcraft595targa' ? i18next.t('almarcraft595withTargaAdd') :
